...
box(CASA_LARG-PAREDE_ESP, Y0+PAREDE_ESP, Z2,  PAREDE_ESP, 5.0100-PAREDE_ESP, PE_DIREITO, "Andar_2_Parede_Dir_A")
...
# X114: X=1,28→1,42, Y=8,75→11,55  (estende 0,14 em cada extremidade para encaixar)
box(PAREDE_ESP+1.000, Y0+3.890, Z2,  PAREDE_ESP, 2.660+PAREDE_ESP, PE_DIREITO, "Suite_Parede_X114")
...
box(BANHO_X_EXT+PAREDE_ESP, Y0+5,0100, Z2,  CASA_LARG-BANHO_X_EXT-PAREDE_ESP*2, PAREDE_ESP, PE_DIREITO, "Suite_Parede_Y987")

# BanhoEsq: movida 0,14 para direita → X=2,52→2,66
PORTA_Y = Y0 + 4.670 + PAREDE_ESP + (1.540 - PORTA_LARG) / 2
box(BANHO_X_EXT+PAREDE_ESP, Y0+4.670+PAREDE_ESP, Z2,  PAREDE_ESP, PORTA_Y-(Y0+4.670+PAREDE_ESP), PE_DIREITO, "Banho_Parede_Esq_Bot")
box(BANHO_X_EXT+PAREDE_ESP, PORTA_Y+PORTA_LARG,  Z2,  PAREDE_ESP, (Y0+6.410)-(PORTA_Y+PORTA_LARG), PE_DIREITO, "Banho_Parede_Esq_Top")
box(BANHO_X_EXT+PAREDE_ESP, PORTA_Y, Z2+PORTA_ALT,  PAREDE_ESP, PORTA_LARG, PE_DIREITO-PORTA_ALT, "Banho_Parede_Esq_Verga")

box(BANHO_X_EXT+PAREDE_ESP, PORTA_Y+PORTA_LARG,  Z2,  PAREDE_ESP, (Y0+6.610)-(PORTA_Y+PORTA_LARG), PE_DIREITO, "Banho_Parede_Esq_Top")
